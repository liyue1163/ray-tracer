...
bool bmp_print_test ( char const *file_in_name )
...
//  Parameters:
//
//    Input, char const *FILE_IN_NAME, the name of the input file.
//
...
bool bmp_read_test ( char const *file_in_name )
...
//  Parameters:
//
//    Input, char const *FILE_OUT_NAME, the name of the output file.
//
//    Input, unsigned long int WIDTH, the X dimension of the image.
//
//    Input, long int HEIGHT, the Y dimension of the image.
...
bool bmp_08_write_test ( char const *file_out_name )
...
bool bmp_24_write_test ( char const *file_out_name )
